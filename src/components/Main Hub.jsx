              ...
              <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4 pt-4">
                    ...
                    <p className="text-red-100">Join 58,000+ donors saving lives daily</p>
                  </div>
                </div>
                <div className="hidden md:block">
                  <div className="relative">
                    <div className="absolute -left-4 -top-4 w-20 h-20 bg-red-500 rounded-full opacity-20"></div>
                    <div className="absolute -right-6 -bottom-6 w-32 h-32 bg-red-500 rounded-full opacity-20"></div>
                  ...
                  <div className="aspect-w-16 aspect-h-9 mb-6">
                    <div className="w-full h-64 md:h-96 bg-gray-200 rounded-lg relative overflow-hidden">
                      {userLocation ? (
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center">
                            <div className="w-full h-full flex items-center justify-center">
                              <div className="text-gray-500">Map Placeholder - Interactive map would be shown here</div>
                            </div>
                            ...
                            {filteredEmergencies.map((emergency, index) => (
                              <div
                                key={index}
                                className="absolute h-6 w-6 bg-red-600 rounded-full flex items-center justify-center text-white text-xs font-bold"
                                style={{
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center">
                            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-red-600 border-r-2 mb-4"></div>
              ...
              <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {testimonials.map((testimonial, index) => (
                    <div key={index} className="bg-red-700 p-6 rounded-xl relative">
